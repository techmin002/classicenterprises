...
class AmcCustomerController extends Controller
{
    ...
    public function service()
    {
        ...
        // Fetch AMC customers with AMC data
        ...
        // Prepare final service list output
        $serviceData = [];

        foreach ($amccustomers->amc as $item) {
            ...
            // Last service start date (AMC Assign date)
            $lastDate = \Carbon\Carbon::parse($item->last_date);

            // Generate service dates every 4 months
            $serviceDates = [];
            $addMonths = 4;
