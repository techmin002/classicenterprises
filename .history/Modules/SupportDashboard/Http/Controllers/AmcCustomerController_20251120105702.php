...
class AmcCustomerController extends Controller
{
    ...
    public function queue()
    {
        ...
        $customers = CustomerTicket::with(['amc', 'customer', 'amccustomer'])->where('branch_id', $branch_id)->where('type', 'amc')->where('status', 'queue')->latest()->get();
    ...
    public function assignStore(Request $request, $id)
    {
        ...
        $amccustomer = AmcCustomer::findOrFail($ticket->amc_customer_id);
        if ($amccustomer) {
            $amccustomer->last_date = now();
    ...
    public function assign()
    {
        ...
        $users = User::where('branch_id', $branch_id)->get();
        $customers = CustomerTicket::with(['amc', 'customer', 'user', 'amccustomer'])->where('branch_id', $branch_id)->where('type', 'amc')->where('status', 'assign')->latest()->get();
    ...
    public function report()
    {
        ...
        $users = User::where('branch_id', $branch_id)->get();
        $customers = CustomerTicket::with(['amc', 'customer', 'user', 'amccustomer'])->where('branch_id', $branch_id)->where('type', 'amc')->where('status', 'complete')->latest()->get();
