...
Route::prefix('outsidercustomer-ticket')->group(function () {
    ...
    Route::get('/report', [OutsiderCustomerController::class, 'report'])->name('outsidercustomer-ticket.report');
    Route::get('/complete', [OutsiderCustomerController::class, 'complete'])->name('outsidercustomer-ticket.complete');
    ...
    Route::post('/store/{id}', [OutsiderCustomerController::class, 'store'])->name('outsidercustomer-ticket.store');
    ...
    Route::get('/details/{id}', [OutsiderCustomerController::class, 'customerDetails'])->name('outsidercustomer-ticket.details');
});

// -----------------------------
// AMC Customer Ticket Routes
// -----------------------------
Route::prefix('amccustomer-ticket')->group(function () {
    ...
    Route::get('/report', [AmcCustomerController::class, 'report'])->name('amccustomer-ticket.report');
    Route::get('/complete', [AmcCustomerController::class, 'complete'])->name('amccustomer-ticket.complete');
    ...
    Route::get('/details/{id}', [AmcCustomerController::class, 'customerDetails'])->name('amccustomer-ticket.details');
});
});
