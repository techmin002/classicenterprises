...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::prefix('registercustomer-ticket')->group(function () {
        ...
        Route::get('/dashboard', [SupportDashboardController::class, 'dashboard'])->name('registercustomer-ticket.dashboard');
    ...
    Route::prefix('outsidercustomer-ticket')->group(function () {
        ...
        Route::get('/dashboard', [SupportDashboardController::class, 'dashboard'])->name('outsidercustomer-ticket.dashboard');
    ...
    Route::prefix('amccustomer-ticket')->group(function () {
        ...
        Route::get('/dashboard', [SupportDashboardController::class, 'dashboard'])->name('amccustomer-ticket.dashboard');
