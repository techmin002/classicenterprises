                                        ...
                                        @foreach ($customers as $key => $exp)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    {{ ($exp->amccustomer->customer_name ?? $exp->customer_name) ?? $exp->customer->lead->name }}
                                                </td>
                                                <td class="text-center">
                                                    {{ ($exp->amccustomer->contact ?? $exp->contact) ?? $exp->customer->lead->mobile }}
                                                </td>
                                                <td class="text-center">
                                                    {{ ($exp->amccustomer->address ?? $exp->address) ??$exp->customer->lead->address }}
                                                </td>
                                                <td class="text-center">
                                                ...
                                                <td>
                                                    ...
                                                    <a type="button"
                                                        href="{{ route('amccustomer-ticket.create', $exp->id) }}"
