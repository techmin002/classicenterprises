                                        ...
                                        @foreach ($customers as $key => $exp)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    {{ $exp->customer_name ?? $exp->customer->lead->name }}</td>
                                                <td class="text-center">{{ $exp->contact ?? $exp->customer->lead->contact }}</td>
                                                <td class="text-center">{{ $exp->address ?? $exp->customer->lead->address }}</td>
                                                {{-- <td class="text-center">
