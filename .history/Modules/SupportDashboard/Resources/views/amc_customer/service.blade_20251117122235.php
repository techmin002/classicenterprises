                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3><strong>AMC Due Services Customer</strong></h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($amccustomer as $customer)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $customer->customer->lead->name ?? $customer->customer_name }}</td>
                                                <td class="text-center">{{ $customer->customer->lead->mobile ?? $customer->contact }}</td>
                                                <td class="text-center">{{ \Carbon\Carbon::parse($customer->date)->format('d M, Y') }}</td>
                                                <td class="text-center">{{ \Carbon\Carbon::parse($customer->amc_end_date)->format('d M, Y') }}
                                                </td>
                                                <td class="text-center">{{ \Carbon\Carbon::parse($customer->next_service_date)->format('d M, Y') }}
                                                </td>
                                                <td class="text-center">{{ $customer->amc->title ?? '' }}</td>
                                                <td class="text-center">{{ $customer->duration_months }}(Months)</td>
