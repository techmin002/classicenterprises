                                        ...
                                        @foreach ($customers as $key => $exp)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    {{ $exp->customer_name ?? $exp->customer->lead->name ?? $exp->amccustomer->customer_name }}</td>
                                                <td class="text-center">{{ $exp->contact ?? $exp->customer->lead->mobile ?? $exp->amccustomer->contact }}
                                                </td>
                                                <td class="text-center">{{ $exp->address ?? $exp->customer->lead->address ?? $exp->amccustomer->address }}
                                                </td>
                                                {{-- <td class="text-center">
