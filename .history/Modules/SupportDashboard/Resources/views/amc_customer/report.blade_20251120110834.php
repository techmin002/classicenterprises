                                        ...
                                        @foreach ($customers as $key => $customer)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @if ($customer->customer && $customer->customer->products && $customer->customer->products->count() > 0)
                                                        @foreach ($customer->customer->products as $customerProduct)
                                                            {{ $customerProduct->product->name }}
                                                        @endforeach
                                                    @else
                                                        {{ $customer->amccustomer->product_name }}
                                                    @endif
                                                ...
                                                <td class="text-center">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <a type="button"
                                                                href="{{ route('amccustomer-ticket.details', $customer->id) }}"
