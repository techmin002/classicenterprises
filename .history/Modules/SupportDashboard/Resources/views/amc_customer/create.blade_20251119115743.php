                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="address"
                                                    value="{{ ucfirst($customer->customer->lead->landline ?? $customer->amccustomer->landline ?? $customer->landline) }}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="email" name="email" id="email"
                                                    value="{{ ucfirst($customer->customer->lead->email ?? $customer->email) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
