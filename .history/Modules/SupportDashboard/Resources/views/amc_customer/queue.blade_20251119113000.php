...
@section('content')
                                        ...
                                        @foreach ($customers as $key => $exp)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    {{ $exp->customer_name ?? ($exp->customer->lead->name ?? $exp->amccustomer->customer_name) }}
                                                </td>
                                                <td class="text-center">
                                                    {{ $exp->contact ?? ($exp->customer->lead->mobile ?? $exp->amccustomer->contact) }}
                                                </td>
                                                <td class="text-center">
                                                    {{ $exp->address ?? ($exp->customer->lead->address ?? $exp->amccustomer->address) }}
                                                </td>
                                                <td class="text-center">

    {{-- 1. Pehle check karo: customer exist hai aur products bhi --}}
    ...
    @else
        ...
        {{-- 2. Agar products nahi mile to AmcCustomer ka product_name print karo --}}
        {{ $exp->product_name }}
                                                        ...
                                                        <div class="modal-dialog modal-md" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <!-- Form for new note -->
                                                                    <form
                                                                        action="{{ route('amccustomer-ticket.message.update', $exp->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('PUT')
