                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="example3" class="table table-bordered table-striped datatable-custom">
                                    ...
                                    <tbody>
                                        @foreach ($serviceData as $key => $customer)
<tr>
    ...
    {{-- AMC Title --}}
    <td class="text-center">{{ $customer['amc_name'] }}</td>

    {{-- AMC Price --}}
    <td class="text-center">Rs. {{ $customer['amc_price'] }}</td>

    {{-- Paid Amount --}}
    <td class="text-center">Rs. {{ $customer['paid_amount'] ?? 0 }}</td>

    {{-- Remaining Amount --}}
    <td class="text-center">Rs. {{ $customer['remaining'] ?? 0 }}</td>

    {{-- Service Dates --}}
    <td class="text-center">
        @foreach ($customer['service_dates'] as $date)
