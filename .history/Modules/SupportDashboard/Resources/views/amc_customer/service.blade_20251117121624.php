                                    ...
                                    <tbody>
                                        @foreach ($amccustomer as $customer)
                                            <tr>
                                                ...
                                                <td>{{ $customer->customer->lead->name ?? $customer->customer_name }}</td>
                                                <td>{{ $customer->customer->lead->mobile ?? $customer->contact }}</td>
                                                <td>{{ \Carbon\Carbon::parse($customer->date)->format('d M, Y') }}</td>
<td>{{ \Carbon\Carbon::parse($customer->amc_end_date)->format('d M, Y') }}</td>
<td>{{ \Carbon\Carbon::parse($customer->next_service_date)->format('d M, Y') }}</td>
                                                <td>{{ $customer->amc->title ?? '' }}</td>
                                                <td>{{ $customer->duration_months }}(Months)</td>
                                                <td>
