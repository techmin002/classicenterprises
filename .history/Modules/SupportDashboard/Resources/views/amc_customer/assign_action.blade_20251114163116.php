<div class="modal fade" id="editCategory{{ $exp->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="border-radius: 8px;">
            ...
            <form action="{{ route('amccustomer-assign.store', $exp->id) }}" method="POST"
                        ...
                        <div class="row gy-3">
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $exp->customer_name ?? $exp->customer->lead->name }}" disabled>
                            </div>
                            ...
                            @endif
                            @if ($exp->customer->lead->name)
                                <input type="hidden" name='customer_id' value="{{ $exp->customer->lead- }}">
                            @endif
