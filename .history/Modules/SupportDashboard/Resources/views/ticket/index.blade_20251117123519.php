                                                                    ...
                                                                    <div class="modal-content border-0 shadow">
                                                                        ...
                                                                        <form
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                @php
    // Use related customer created_at if exists, otherwise fallback to $customer->created_at
    $customerCreatedAt = $customer->customer->created_at ?? $customer->created_at;

    // Calculate 1-year warranty
    $warrantyExpiryDate = \Carbon\Carbon::parse($customerCreatedAt)->addYear();

    $isWarrantyIn = \Carbon\Carbon::now()->lt($warrantyExpiryDate);
@endphp
                                                                                <div class="form-group">
                                                                                    <label for="warranty"
                                                                                        class="font-weight-bold">Warranty</label>
