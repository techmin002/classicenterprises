                                        ...
                                        <div class="card-body p-2">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6 mb-2"><strong>Address:</strong>
                                                    {{ $customer->customer->lead->name ?? ($customer->amccustomer->customer_name ?? $customer->customer_name) }}</div>
                                                ...
                                                <div class="col-12 col-md-6 mb-2"><strong>Assign To: </strong><span
                                                        class="text-muted"><div class="col-12 col-md-6 mb-2"><strong>Time: </strong><span
                                                        class="text-muted">{{ $customer->created_time ?? 'N/A' }}</span>
                                                </div></span>
                                                </div>
