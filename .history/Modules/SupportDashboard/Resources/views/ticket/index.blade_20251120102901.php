                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="support_type"
                                                                                        class="font-weight-bold">SupportCategory</label>
                                                                                        <select name="support_type" id="support_type"
                                                                                        class="form-control">
                                                                                        <option value="" selected disabled>Select Support Type</option>
                                                                                        <option value="normal_service">Maintenance</option>
                                                                                        <option value="maintenance">Filter Leakage</option>
                                                                                        <option value="location_shifting">Location Shifting</option>
                                                                                        <option value="location_shifting">Regular Servicing</option>
