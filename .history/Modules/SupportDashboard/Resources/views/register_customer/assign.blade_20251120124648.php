                                    ...
                                    <tbody>
                                        @foreach ($customers as $key => $exp)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $exp->customer->lead->name }}</td>
                                                <td class="text-center">{{ $exp->customer->lead->mobile }}</td>
                                                <td class="text-center">{{ $exp->customer->lead->address }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a type="button"
                                                        href="{{ route('registercustomer-ticket.create', $exp->id) }}"
                                                    ...
                                                    <button type="button" class="btn btn-info btn-sm" title="Note"
                                                        data-toggle="modal" data-target="#noteModal{{ $exp->id }}">
