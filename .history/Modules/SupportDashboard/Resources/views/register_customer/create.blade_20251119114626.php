...
@section('content')
    <div class="content-wrapper" style="background-color: #f5f7fa;">
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ route('store.registercustomer', $customer['id']) }}" method="post"
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="name" id="customer_name"
                                                    readonly value="{{ ucfirst($customer->customer->lead['name']) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="tel"
                                                    ...
                                                    value="{{ $customer->customer->lead['mobile'] }}">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="tel"
                                                    ...
                                                    value="{{ $customer->customer->lead['landline'] }}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="address"
                                                    value="{{ ucfirst($customer->customer->lead['address']) }}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="email" name="email" id="email"
                                                    value="{{ ucfirst($customer->customer->lead['email']) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text"
                                                    value="{{ ucfirst($customer->customer->lead['lead_source']) }}"
                                                    name="lead_source" readonly>
                                            </div>
                                        </div>

                                        <!-- Hidden Branch Code -->
                                        <input type="hidden" id="branch_code"
                                            value="{{ $customer->customer->branch->branch_code ?? '' }}">
                                    </div>
                                </div>
                            </div>
                        </div>
