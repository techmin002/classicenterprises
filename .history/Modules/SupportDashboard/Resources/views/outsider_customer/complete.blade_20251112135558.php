                                    ...
                                    <tbody>
                                        @foreach ($customers as $key => $customer)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $customer->customer->lead->contact }}</td>
                                                <td class="text-center">{{ $customer->customer->lead->address }}</td>
                                                ...
                                                <td class="text-center">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <a type="button"
                                                                href="{{ route('outsidercustomer-ticket.details', $customer->id) }}"
