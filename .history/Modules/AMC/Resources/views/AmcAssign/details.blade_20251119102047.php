                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 mb-2">
                                ...
                                <strong>Name:</strong> {{ $customer->lead->name ?? '-' }} <br>
                                <strong>Address:</strong>{{ $customer->lead->address ?? '-' }} <br>
                                <strong>Email:</strong> {{ $customer->lead->email ?? '-' }}  <br>
                            </div>
                            <div class="col-md-4 mb-2">
                                <span >
