                    ...
                    <div class="col-md-12">
                        <div class="card shadow-sm mb-4 border-0 rounded">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2"><strong>Paid Amount:</strong> {{ ($customer->cash_amount + $customer->online_amount + $customer->cheque_amount ) ?? '0' }}</div>
                                <div class="mb-2 text-danger"><strong>Due Amount:</strong>
                                    {{ $customer->due_amount - ($customer->cash_amount + $customer->online_amount + $customer->cheque_amount )?? 'due_amount' }}
                                </div>
