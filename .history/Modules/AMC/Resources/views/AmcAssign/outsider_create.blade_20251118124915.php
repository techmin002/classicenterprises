                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mt-2">
                                    ...
                                    <input type="tel" name="landline" class="form-control"
                                        placeholder="Enter Alternate Mobile Number" pattern="\d{10}" maxlength="10"
                                        oninput="this.value=this.value.replace(/[^0-9]/g,'').slice(0,10);">
                                </div>
                                ...
                                <div class="col-md-4 mt-2">
                                    <div class="form-group">
                                        ...
                                        <select name="sales" id="amc_id" class="form-control" required>
                                ...
                                <div class="col-md-4 mt-2">
                                    ...
                                    <input type="tel" name="product_name" class="form-control"
                                        placeholder="Enter Previous Product Name" required>
                                </div>
