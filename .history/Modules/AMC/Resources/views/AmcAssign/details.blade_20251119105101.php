                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 mb-2"><strong>Amc Sales:</strong>
                                {{ ucfirst($customer->user->name) }}</div>
                            ...
                            <div class="col-12 col-md-6 mb-2"><strong>Time: </strong><span
                                    class="text-muted">{{ $customer->created_time ?? 'N/A' }}</span></div>
                            @if ($customer->type == 'outsider')
                                <div class="col-12 col-md-6 mb-2"><strong>Previous Product: </strong><span
                                        class="text-muted">{{ $customer->product_name ?? 'N/A' }}</span></div>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card shadow-sm mb-4 border-0 rounded">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2"><strong>Paid Amount:</strong>
                                    {{ $customer->cash_amount + $customer->online_amount + $customer->cheque_amount ?? '0' }}
                                </div>
                                <div class="mb-2 text-danger"><strong>Due Amount:</strong>
                                    {{ $customer->amount - ($customer->cash_amount + $customer->online_amount + $customer->cheque_amount) }}
                                </div>
