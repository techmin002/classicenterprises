                ...
                <div class="card shadow-sm mb-4 border-0 rounded">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 mb-2"><strong>Contact:</strong>  {{ $customer->customer->lead->mobile ?? $customer->contact }}
                            </div>
                            <div class="col-12 col-md-6 mb-2"><strong>Email:</strong>  {{ $customer->customer->lead->email ?? $customer->customer_name }}
                            </div>
