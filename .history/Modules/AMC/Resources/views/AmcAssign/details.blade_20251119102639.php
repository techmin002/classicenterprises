                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 mb-2"><strong>Address:</strong>
                                {{ $customer->customer->lead->address ?? $customer->customer_name }}</div>
                            <div class="col-12 col-md-6 mb-2"><strong>Contact:</strong>  {{ $customer->customer->lead->name ?? $customer->customer_name }}
                            </div>
                            <div class="col-12 col-md-6 mb-2"><strong>Email:</strong>  {{ $customer->customer->lead->name ?? $customer->customer_name }}
                            </div>
