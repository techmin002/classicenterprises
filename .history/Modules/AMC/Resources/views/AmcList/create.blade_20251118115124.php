<!-- Create AMC Modal -->
<div class="modal fade" id="createAmcModal" tabindex="-1" role="dialog" aria-labelledby="createAmcModalLabel" aria-hidden="true">
                    ...
                    <div class="card-body">
                        <div class="row gy-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="title" class="form-control" placeholder="Enter AMC Type" required>
                            </div>
