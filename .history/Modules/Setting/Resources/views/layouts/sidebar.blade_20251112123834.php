            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('supportdashboard.index') }}"
                                class="nav-link {{ request()->routeIs('supportdashboard.index') ? 'active' : '' }}">
                                <p>Dashboard</p>
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="#"
                        class="nav-link {{ request()->routeIs(['supportdashboard.*', 'amccustomer-ticket.*']) ? 'active' : '' }}">
                        <i class="nav-icon fas fa-newspaper"></i>
                        <p>
                            AMC-C Tickets
                            <i class="right fas fa-angle-left"></i>
                ...
                <li class="nav-header text-primary border-top border-success pt-1 mt-3">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('outsidersupportdashboard.dashboard') }}"
                                class="nav-link {{ request()->routeIs('outsidersupportdashboard.dashboard') ? 'active' : '' }}">
                                <p>Dashboard</p>
                            </a>
                        </li>
                        <li class="nav-item">
