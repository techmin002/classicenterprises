        ...
        <nav class="mt-2 mb-4">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="#"
                        class="nav-link {{ request()->routeIs(['supportdashboard.*', 'amccustomer-ticket.*', 'amcassign.*']) ? 'active' : '' }}">
                        <i class="nav-icon fas fa-newspaper"></i>
                        <p>
                            AMC
                            <i class="right fas fa-angle-left"></i>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('amc.index.index') }}"
                                class="nav-link {{ request()->routeIs('amc.index.index') ? 'active' : '' }}">
                                <p>Amc Policy</p>
                            </a>
                        </li>
                        <li class="nav-item">
