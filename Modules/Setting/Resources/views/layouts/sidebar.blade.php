              ...
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                      ...
                      @can('access_sliders')
                          ...
                          <li class="nav-item">
                              <a href="#" class="nav-link @if (request()->routeIs([
                                  ...
                                  ]) && request()->route('sale_type') === 'classic_customer') active @endif">
                              ...
                              <ul class="nav nav-treeview">
                                  <li class="nav-item">
                                      <a href="{{ route('installation-queue.index', 'classic_customer') }}"
                                          class="nav-link @if (request()->routeIs('installation-queue.index') && request()->route('sale_type') === 'classic_customer') active @endif">
                                          <p>Installation Queue</p>
                                      </a>
                                  </li>
                                  <li class="nav-item">
                                      <a href="{{ route('installation-assign.index', 'classic_customer') }}"
                                          class="nav-link @if (request()->routeIs('installation-assign.index') && request()->route('sale_type') === 'classic_customer') active @endif">
                                          <p>Installation Assign</p>
                                      </a>
                                  </li>
                                  <li class="nav-item">
                                      <a href="{{ route('installation.reports', 'classic_customer') }}"
                                          class="nav-link @if (request()->routeIs('installation.reports') && request()->route('sale_type') === 'classic_customer') active @endif">
                                          <p>Installation Reports</p>
                                      </a>
                                  </li>
                                  <li class="nav-item">
                                      <a href="{{ route('installation.complete', 'classic_customer') }}"
                                          class="nav-link @if (request()->routeIs('installation.complete') && request()->route('sale_type') === 'classic_customer') active @endif">
                  ...
                  @can('access_ticket')
                      ...
                      <li class="nav-header text-primary border-top border-success pt-1">
                          <strong>CE Support Dashboard</strong>
                      </li>
                      <li class="nav-item">
                          <a href="#"
                              class="nav-link {{ request()->routeIs(['supportdashboard.*', 'supportdashboard-task.*']) ? 'active' : '' }}">
                              <i class="nav-icon fas fa-newspaper"></i>
                              <p>
                                  Tickets
                                  <i class="right fas fa-angle-left"></i>
                      ...
                      <li class="nav-item">
                          <a href="#"
                              class="nav-link {{ request()->routeIs(['outsidersupportdashboard.*', 'outsidersupportdashboard-task.*']) ? 'active' : '' }}">
                              <i class="nav-icon fas fa-newspaper"></i>
                              <p>
                                  Tickets
                                  <i class="right fas fa-angle-left"></i>
