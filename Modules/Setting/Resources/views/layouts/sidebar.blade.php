...
<style>
    ...
    .user-panel .image {
        ...
        overflow: hidden;
        border: none;
        /* remove border if you want clean logo */
        flex-shrink: 0;
        display: flex;
        align-items: center;
        justify-content: center;
        ...
        <nav class="mt-2 mb-4">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                @can('access_customers')
                    {{-- Register Customer --}}
                    <li
                        class="nav-item {{ request()->routeIs(['supportdashboard.*', 'registercustomer-ticket.*']) ? 'menu-is-opening menu-open' : '' }}">
                        <a href="#"
                    ...
                    {{-- AMC Customer --}}
                    <li
                        class="nav-item {{ request()->routeIs(['supportdashboard.*', 'amccustomer-ticket.*', 'amcassign.*', 'amc.*']) ? 'menu-is-opening menu-open' : '' }}">
                        <a href="#"
                    ...
                    {{-- Outsider Customer --}}
                    <li
                        class="nav-item {{ request()->routeIs(['supportdashboard.*', 'outsidercustomer-ticket.*']) ? 'menu-is-opening menu-open' : '' }}">
                        <a href="#"
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('outsidercustomer-ticket.regular-service') }}"
                                    class="nav-link {{ request()->routeIs('outsidercustomer-ticket.regular-service') ? 'active' : '' }}">
                                    <p>Regular Service</p>
                                </a>
                            </li>
                            <li class="nav-item">
                ...
                @can('access_ime')
                    ...
                    <li
                        class="nav-item {{ request()->routeIs('inventries', 'inventory.*', 'suppliers.*', 'suppliers_edit', 'device-purchases.*', 'device_purchase_machineries_accessories', 'device_purchase_edit', 'sales.*', 'stock-transfers.*', 'stock-issue.*') ? 'menu-is-opening menu-open' : '' }}">
                        <a href="#"
                            class="nav-link {{ request()->routeIs('inventries', 'inventory.*', 'suppliers.*', 'suppliers_edit', 'device-purchases.*', 'device_purchase_machineries_accessories', 'device_purchase_edit', 'sales.*', 'stock-transfers.*', 'stock-issue.*') ? 'active' : '' }}">
                ...
                @can('access_pettycash')
                    <li
                        class="nav-item {{ request()->routeIs(['pettycash-addcash.*', 'pettycash-request.*', 'pettycash-transfer.*', 'pettycash-transaction.*', 'expenses-categories.*', 'petty.expenses.*']) ? 'menu-is-opening menu-open' : '' }}">
                        <a href="#"
                            class="nav-link {{ request()->routeIs(['pettycash-addcash.*', 'pettycash-request.*', 'pettycash-transfer.*', 'pettycash-transaction.*', 'expenses-categories.*', 'petty.expenses.*']) ? 'active' : '' }}">
                ...
                @can('access_vehicle')
                    <li
                        class="nav-item {{ request()->routeIs(['bike.*', 'petrol.*', 'service.*']) ? 'menu-is-opening menu-open' : '' }}">
                        <a href="#"
                ...
                @can('access_finance')
                    <li
                        class="nav-item {{ request()->routeIs(['firstbill.*', 'payment-verification.*', 'finance.*', 'daily.*']) ? 'menu-is-opening menu-open' : '' }}">
                        <a href="#"
