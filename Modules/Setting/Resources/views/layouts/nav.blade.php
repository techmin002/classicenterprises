<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    @php
        $branches = Modules\Branch\Entities\Branch::select('name', 'id', 'status')->where('status', 'on')->get();
        // dd(session('branch_id'));
        $bra = Modules\Branch\Entities\Branch::select('name')->where('id', session('branch_id'))->first();
        // dd(session('branch_id'));
    @endphp
