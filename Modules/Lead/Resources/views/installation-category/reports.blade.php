                                        ...
                                        @foreach ($customers as $key => $customer)
                                            <tr>
                                                ...
                                                <td>
                                                        ...
                                                        <a type="button" href="{{ route('customer.details',$customer->id) }}" class="btn btn-info btn-sm" disabled data-toggle="tooltip" data-placement="top" title="Convert lead into Client">
                                                            View Detail's
                                                        </a>
                                                </td>
                                            </tr>
