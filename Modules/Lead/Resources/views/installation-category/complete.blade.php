...
@section('title', "$installation_category Installation Complete")
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item active">{{ $installation_category }} Installation Complete</li>
    </ol>
@endsection
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{ $installation_category }} Installation Complete</h1>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <div class="btn-group petty-filter" role="group">
                                    <a href="{{ route('installation-category.complete', ['installation_category' => $installation_category, 'filter' => '7days']) }}"
                                        class="btn {{ request('filter') == '7days' ? 'active-btn' : '' }}">7 Days</a>

                                    <a href="{{ route('installation-category.complete', ['installation_category' => $installation_category, 'filter' => '15days']) }}"
                                        class="btn {{ request('filter') == '15days' ? 'active-btn' : '' }}">15 Days</a>

                                    <a href="{{ route('installation-category.complete', ['installation_category' => $installation_category, 'filter' => '1month']) }}"
                            ...
                            <div id="customDateFilter"
                                ...
                                <form method="GET"
                                    action="{{ route('installation-category.complete', ['installation_category' => $installation_category]) }}"
                                    class="row g-2">
                                    <div class="col-auto">
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 mt-2">
                                                            ...
                                                            <a type="button"
                                                                href="{{ route('customer.documents', $exp->id) }}"
                                                                class="btn btn-info btn-sm" disabled data-toggle="tooltip"
