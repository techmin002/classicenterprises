<div class="modal fade" id="editCategory{{ $exp->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="border-radius: 8px;">
            ...
            <form action="{{ route('installation-category-assign.store', $exp->id) }}" method="POST"
                    ...
                    <div class="container">
                        <div class="row gy-3">
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" value="{{ $exp->lead->name ?? 'N/A' }}"
                                    disabled>
                            </div>
                            <div class="col-lg-6">
                                <label class="form-label">Assign Lead:</label>
                                <input type="text" class="form-control"
                                    value="{{ $exp->assignLead->name ?? 'No User Assigned' }}" disabled>
                            </div>
