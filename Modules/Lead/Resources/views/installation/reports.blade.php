...
@section('title', ucfirst($saleType) . ' Installation Reports')

@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item active">{{ ucfirst($saleType) }} Installation Reports</li>
    </ol>
@endsection
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{ ucfirst($saleType) }} Installation Reports</h1>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="btn-group petty-filter" role="group">
                                    <a href="{{ route('installation.reports', ['sale_type' => $saleType, 'filter' => '7days']) }}"
                                        class="btn {{ request('filter') == '7days' ? 'active-btn' : '' }}">7 Days</a>

                                    <a href="{{ route('installation.reports', ['sale_type' => $saleType, 'filter' => '15days']) }}"
                                        class="btn {{ request('filter') == '15days' ? 'active-btn' : '' }}">15 Days</a>

                                    <a href="{{ route('installation.reports', ['sale_type' => $saleType, 'filter' => '1month']) }}"
                            ...
                            <div id="customDateFilter"
                                ...
                                <form method="GET"
                                    action="{{ route('installation.reports', ['sale_type' => $saleType]) }}"
                                    class="row g-2">
                                    <div class="col-auto">
