                                    ...
                                    <div class="col-2">
                                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                            ...
                                            <button class="nav-link active" id="v-pills-home-tab" data-toggle="pill"
                                                ...
                                                aria-controls="v-pills-home" aria-selected="true">Machineries</button>
                                            <button class="nav-link" id="v-pills-profile-tab" data-toggle="pill"
                                                data-target="#v-pills-profile" type="button" role="tab"
                                                aria-controls="v-pills-profile" aria-selected="false">Accessories</button>
                                        </div>
                                    </div>
                                    <div class="col-10">
                                                                        ...
                                                                        <tbody>
                                                                            @foreach ($customer->products as $product)
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <img src="{{ asset('upload/images/machinery/' . $pro['image']) }}"
                                                                                            style="width: 200px"
                                                                                            alt="">
                                                                                    </td>
                                                                        ...
                                                                        <tbody>
                                                                            @foreach ($customer->accessories as $accessory)
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        @php
                                                                                            $pro = Modules\Product\Entities\Accessory::select(
                                                                                                'name',
                                                                                                'original_price',
                                                                                                'image',
                                                                                            )
                                                                                    ...
                                                                                    <td>
                                                                                        <img src="{{ asset('upload/images/accessory/' . $pro['image']) }}"
                                                                                            style="width: 200px"
                                                                                            alt="">
                                                                                    </td>
                                                                                    <td>{{ $accessory['accessory_price'] }}
                                                                                    </td>
                                                                                    <td>{{ $accessory['accessory_qty'] }}
                                                                                    </td>
                                                                                    <td>{{ $accessory['accessory_total'] }}
                                                                                    </td>
