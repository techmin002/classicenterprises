...
@section('title', 'Register Customer Assign AMC')

@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item active">Register Customer Assign AMC</li>
    </ol>
@endsection
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Register Customer Assign AMC</h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <form id="amcAssignForm" action="{{ route('amcassign.store') }}" method="POST"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <input type="hidden" name='customer_type' value="register">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="amount" id="total_amount" class="form-control" required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-md-6" id="method_col" style="display:none;">
                                            ...
                                            <select name="payment_method" id="payment_method_register" class="form-control">
                                    ...
                                    <div id="cash_div_register" class="row method-fields" style="display:none;">
                                        ...
                                        <div class="col-md-6 mt-2">
                                            ...
                                            <input type="file" name="cash_receipt" class="form-control" accept="image/*">
                                        </div>
                                    </div>
