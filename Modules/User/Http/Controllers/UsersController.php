...
class UsersController extends Controller
{
    public function index()
    {
        ...
        $users = User::where('branch_id', session('branch_id'))->latest()->get();
    ...
    public function store(Request $request)
    {
        ...
        Log::create([
            'perform'   => auth()->user()->name . ' created user: ' . $user->name . ' (' . $user->email . ') at ' . now(),
    ...
    public function update(Request $request, User $user)
    {
        ...
        Log::create([
            'perform'   => auth()->user()->name . ' updated user: ' . $user->name . ' (' . $user->email . ') at ' . now(),
            'user_id'   => auth()->user()->id,
            'branch_id' => session('branch_id') ?? auth()->user()->branch_id,
            'url'       => url()->current(),
        ]);
    ...
    public function destroy(User $user)
    {
        ...
        Log::create([
            'perform'   => auth()->user()->name . ' delete user: ' . $user->name . ' (' . $user->email . ') at ' . now(),
            'user_id'   => auth()->user()->id,
            'branch_id' => session('branch_id') ?? auth()->user()->branch_id,
            'url'       => url()->current(),
        ]);
    ...
    public function status($id)
    {
        ...
        Log::create([
            'perform'   => auth()->user()->name . ' changed status of user: '
