...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Outsider Customer Ticket Assign</h1>
                </div>
                <div class="col-sm-6">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $exp->customer_name ?? 'N/A' }}</td>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex mb-2">
                                                <a type="button" href="{{ route('outsidercustomer-ticket.create', $exp->id) }}" class="btn btn-secondary btn-sm mr-1" disabled data-toggle="tooltip" data-placement="top" title="Task Complete">
                                                    <i class="fa fa-user-plus"></i>
                                                </a>

                                                <a data-toggle="modal" data-target="#editCategory{{ $exp->id }}" class="btn btn-primary btn-sm">
                                                    <i class="fa fa-user-cog" title="Change Technician"></i>
                                                </a>

                                                @include('supportdashboard::outsider_customer.assign_action')
                                            </div>

                                            <!-- Second row: Note + Delete -->
                                            <div class="d-flex mb-2">
                                            ...
                                            <!-- Third row: Details -->
                                            <div class="mb-2">
                                                <a type="button" href="{{ route('ticket_customer.details', $exp->id) }}" class="btn btn-info btn-sm" disabled data-toggle="tooltip" data-placement="top" title="Details">
                                                    Detail's
                                                </a>
                                            </div>

                                            <!-- Note Modal code remains the same -->
                                        </td>
