...
<div class="content-wrapper" style="background-color: #f5f7fa;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Outsider Customer Create </h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('store.outsidercustomer', $customer['id']) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input class="form-control" type="text" name="name" id="customer_name" value="{{ ucfirst($customer->customer_name) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Contact Number</label>
                                            <input class="form-control" type="tel" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);" pattern="\d{10}" maxlength="10" name="mobile" value="{{ $customer->contact }}">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Alternate Contact Number</label>
                                            <input class="form-control" type="tel" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);" pattern="\d{10}" maxlength="10" name="landline" value="{{ $customer->landline }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input class="form-control" type="text" name="address" value="{{ ucfirst($customer->address) }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <!-- Hidden Branch Code -->
                                    <input type="hidden" id="branch_code" value="{{ $customer->branch->branch_code ?? '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
