                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="btn-container d-flex justify-content-between">
                                            ...
                                            <a href="" class="btn btn-info text-white btn-sm" data-toggle="modal"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="contact"
                                                                                class="font-weight-bold">Contact
                                                                                Number</label>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="contact"
                                                                                class="font-weight-bold">Alternate
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="customer_name"
                                                                                class="font-weight-bold">Previous Product
                                                                                Name</label>
                                                ...
                                                @foreach ($amccustomer as $key => $customer)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ($customer->type == 'register')
                                                                <a type="button"
                                                                    href="{{ route('customer.details', $customer->customer->id) }}"
