                    ...
                    <div class="card shadow-sm">
                        <div class="card-header bg-info text-white">
                            <h5><strong>Customer Information</strong>
                                {{ $customer->customer->lead->name ?? ($customer->amccustomer->customer_name ??
                                $customer->customer_name) }}
                                <h5>
                                    <h5><strong>Service Charge :</strong>
                                        {{ $customer->service_charge ?? 'Pending Service' }}</h5>
                        </div>
                                    ...
                                    <div class="card-body p-2">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6 mb-2">
                                                ...
                                                {{ $customer->customer->user_name ?? ($customer->amccustomer->user_name
                                                ?? $customer->user_name) }}
                                            </div>
                                            <div class="col-12 col-md-6 mb-2"><strong>Name:</strong>
                                                {{ $customer->customer->lead->name ??
                                                ($customer->amccustomer->customer_name ?? $customer->customer_name) }}
                                            </div>
                                            <div class="col-12 col-md-6 mb-2"><strong>Address:</strong>
                                                {{ $customer->customer->lead->address ??
                                                ($customer->amccustomer->address ?? $customer->address) }}
                                            </div>
                                            <div class="col-12 col-md-6 mb-2"><strong>Contact:</strong>
                                                {{ $customer->customer->lead->mobile ?? ($customer->amccustomer->contact
                                                ?? $customer->contact) }}
                                            </div>
                                            <div class="col-12 col-md-6 mb-2"><strong>Email:</strong>
                                                {{ $customer->customer->lead->email ?? ($customer->amccustomer->email ??
                                                $customer->email) }}
                                            </div>
                                            ...
                                            <div class="col-12 col-md-6 mb-2"><strong>Sales Convert:</strong>
                                                {{ $customer->customer->convertedBy->name ?? 'NO' }}
                                            ...
                                            <div class="col-6 mb-2">
                                                <div class="card border-primary h-100">
                                                    ...
                                                    <div class="card-body text-center">
                                                        ...
                                                        file_exists(public_path('receipts/' .
                                                        $customer->product_document)))
                                                        <img src="{{ asset('receipts/' . $customer->product_document) }}"
                                                            alt="Product Image" class="img-fluid img-thumbnail"
                                            ...
                                            <div class="col-6 mb-2">
                                                <div class="card border-success h-100">
                                                    <div class="card-header bg-success text-white text-center">
                                                        <strong>Warranty Image</strong>
                                                    </div>
                                                    <div class="card-body text-center">
                                                        @if ($customer->warranty_card &&
                                                        file_exists(public_path('receipts/' .
                                                        $customer->warranty_card)))
                                                        <img src="{{ asset('receipts/' . $customer->warranty_card) }}"
                                                            alt="Warranty Image" class="img-fluid img-thumbnail"
                                                            style="max-height:200px;">
                                                        @else
                                                        <p class="text-muted">No Image</p>
                                                        @endif
