                                        ...
                                        <div class="card-body p-2">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6 mb-2"><strong>Email:</strong>
                                                    {{ $customer->customer->lead->email ?? ($customer->amccustomer->email ?? $customer->email) }}
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 mb-2">
                                                    <div class="card border-primary h-100">
                                                        ...
                                                        <div class="card-body text-center">
                                                            @if ($customer->product_document && file_exists(public_path('receipts/' . $customer->product_document)))
                                                ...
                                                <div class="col-6 mb-2">
                                                    <div class="card border-success h-100">
                                                        ...
                                                        <div class="card-body text-center">
                                                            @if ($customer->warranty_card && file_exists(public_path('receipts/' . $customer->warranty_card)))
