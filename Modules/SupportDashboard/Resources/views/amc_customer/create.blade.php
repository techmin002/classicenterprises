...
<div class="content-wrapper" style="background-color: #f5f7fa;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Amc Customer Create </h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    @if (optional($customer->customer)->lead)
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="name" id="customer_name"
                                                value="{{ ucfirst($customer->amccustomer->customer_name ?? ($customer->customer_name ?? $customer->customer->lead->name)) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="tel"
                                                ...
                                                value="{{ $customer->customer->lead->mobile ?? ($customer->amccustomer->contact ?? $customer->contact) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="tel"
                                                ...
                                                value="{{ $customer->customer->lead->landline ?? ($customer->amccustomer->landline ?? $customer->landline) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="address"
                                                value="{{ ucfirst($customer->customer->lead->address ?? ($customer->amccustomer->address ?? $customer->address)) }}">
                                        </div>
                                    </div>
                                </div>
