...
@section('title', ' Ticket Assign')

@section('breadcrumb')
<ol class="breadcrumb border-0 m-0">
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
    <li class="breadcrumb-item active">Ticket Assign</li>
</ol>
@endsection
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Amc Customer Ticket Assign</h1>
                </div>
                <div class="col-sm-6">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex mb-2">
                                                <a type="button" href="{{ route('amccustomer-ticket.create', $exp->id) }}" class="btn btn-secondary btn-sm mr-1" disabled data-toggle="tooltip" data-placement="top" title="Convert lead into Client">
                                            ...
                                            <div class="d-flex mb-2">
                                                ...
                                                <!-- Note Modal -->
                                                <div class="modal fade" id="noteModal{{ $exp->id }}" tabindex="-1" role="dialog" title="Note" aria-labelledby="noteModalLabel{{ $exp->id }}" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="noteModalLabel{{ $exp->id }}">Notes
                                                                </h5>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <!-- Form for new note -->
                                                                <form action="{{ route('amccustomer-ticket.message.update', $exp->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('PUT')
                                                                ...
                                                                <div class="mb-3 mt-3">
                                                                    ...
                                                                    @else
                                                                    <p class="text-muted mt-2">No notes added
                                                                        yet.
                                                                    </p>
                                                                    @endif
                                                                </div>
                                            ...
                                            <div class="mb-2">
                                                <a type="button" href="{{ route('customer.details', $exp->id) }}" class="btn btn-info btn-sm" disabled data-toggle="tooltip" data-placement="top" title="Details">Detail's
                                                </a>
                                            </div>
                                        </td>
                                    </tr>
