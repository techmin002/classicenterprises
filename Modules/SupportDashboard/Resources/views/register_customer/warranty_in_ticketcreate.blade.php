...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Warranty In Customer Ticket Create</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h3><strong>Warranty In Customer</strong></h3>
                            </div>
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped datatable-custom">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal{{ $customer->id }}"> Create
                                                    Ticket</a>
