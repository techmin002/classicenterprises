...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Register Customer Ticket Complete</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card border-primary mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills mb-3" id="maintenanceSubTabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="warranty-in-tab" data-bs-toggle="pill" data-bs-target="#warranty-in" type="button" role="tab" aria-controls="warranty-in" aria-selected="true">Warranty In</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="warranty-out-tab" data-bs-toggle="pill" data-bs-target="#warranty-out" type="button" role="tab" aria-controls="warranty-out" aria-selected="false">Warranty Out</button>
                                </li>
                            </ul>
                    ...
                    <div class="card border-warning mb-4">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills mb-3" id="filterLeakageSubTabs" role="tablist">
                                <li class="nav-item">
                                    <button class="nav-link active" id="filter-warranty-in-tab" data-bs-toggle="pill" data-bs-target="#filter-warranty-in" type="button">Warranty In</button>
                                </li>
                                <li class="nav-item">
                                    <button class="nav-link" id="filter-warranty-out-tab" data-bs-toggle="pill" data-bs-target="#filter-warranty-out" type="button">Warranty Out</button>
                                </li>
                            </ul>
                    ...
                    <div class="card border-secondary mb-4">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills mb-3" id="locationSubTabs" role="tablist">
                                <li class="nav-item">
                                    <button class="nav-link active" id="location-warranty-in-tab" data-bs-toggle="pill" data-bs-target="#location-warranty-in" type="button">Warranty In</button>
                                </li>
                                <li class="nav-item">
                                    <button class="nav-link" id="location-warranty-out-tab" data-bs-toggle="pill" data-bs-target="#location-warranty-out" type="button">Warranty Out</button>
                                </li>
                            </ul>
                            <div class="tab-content">
                    ...
                    <div class="card border-dark mb-4">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills mb-3" id="regularServiceSubTabs" role="tablist">
                                <li class="nav-item">
                                    <button class="nav-link active" id="regular-warranty-in-tab" data-bs-toggle="pill" data-bs-target="#regular-warranty-in" type="button">Warranty In</button>
                                </li>
                                <li class="nav-item">
                                    <button class="nav-link" id="regular-warranty-out-tab" data-bs-toggle="pill" data-bs-target="#regular-warranty-out" type="button">Warranty Out</button>
                                </li>
                            </ul>
                            <div class="tab-content">
