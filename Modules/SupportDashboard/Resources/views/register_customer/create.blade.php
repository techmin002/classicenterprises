...
<div class="content-wrapper" style="background-color: #f5f7fa;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Register Customer Create</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('store.registercustomer', $customer['id']) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input class="form-control" type="text" name="name" id="customer_name" readonly value="{{ ucfirst($customer->customer->lead['name']) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Contact Number</label>
                                            <input class="form-control" type="tel" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);" pattern="\d{10}" maxlength="10" name="mobile" value="{{ $customer->customer->lead['mobile'] }}">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Alternate Contact Number</label>
                                            <input class="form-control" type="tel" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);" pattern="\d{10}" maxlength="10" name="landline" value="{{ $customer->customer->lead['landline'] }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input class="form-control" type="text" name="address" value="{{ ucfirst($customer->customer->lead['address']) }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <!-- Hidden Branch Code -->
                                    <input type="hidden" id="branch_code" value="{{ $customer->customer->branch->branch_code ?? '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Amount</label>
                                            <input type="number" name="grand_total" id="overallTotal" class="form-control" value="{{ $customer->total_amount ?? 0 }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="service_charge" id="serviceCharge" class="form-control" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="remaining_amount" id="remainingAmount" class="form-control" value="{{ ($customer->total_amount ?? 0) + ($customer->service_charge ?? 0) }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="product_document" class="form-control" accept=".pdf,.jpg,.jpeg,.png" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="warrantyCard">Upload Warranty Card</label>
                                                <input type="file" name="warranty_card" class="form-control" accept=".pdf,.jpg,.jpeg,.png">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <textarea name="remarks" class="form-control" cols="30" rows="3" required placeholder="Enter any remarks here..."></textarea>
                            </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function updateTotal() {
            let amount = parseFloat(document.getElementById('overallTotal').value) || 0;
            let serviceCharge = parseFloat(document.getElementById('serviceCharge').value) || 0;

            document.getElementById('total_amount').value = amount + serviceCharge;
        }

        // Sirf total_amount update hoga, baaki fields untouched
        document.getElementById('serviceCharge').addEventListener('input', updateTotal);

        updateTotal(); // Page load par bhi calculate ho jaye
    });
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const paidDate = document.querySelector('input[name="paid_date"]');

        function togglePaymentRequirements() {
            if (serviceType.value === 'paid') {
                paymentStatus.setAttribute('required', true);
                serviceCharge.setAttribute('required', true);
                paidDate.setAttribute('required', true);
            } else {
                paymentStatus.removeAttribute('required');
                serviceCharge.removeAttribute('required');
                paidDate.removeAttribute('required');
            }
        }

        // Initial check
        togglePaymentRequirements();

        // On change
        serviceType.addEventListener('change', togglePaymentRequirements);
    });
