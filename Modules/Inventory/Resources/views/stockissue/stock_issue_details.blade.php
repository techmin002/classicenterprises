<!-- View Modal -->
<div class="modal fade" id="viewModal{{ $tool->id }}" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel" aria-hidden="true">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img src="{{ asset('upload/images/machinery/' . $mach->machinery->image) }}" alt="Machinery Image" width="60">
                                @else
                                N/A
                                @endif
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img src="{{ asset('upload/images/accessory/' . $acc->accessory->image) }}" alt="Accessory Image" width="60">
                                @else
                                N/A
                                @endif
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img src="{{ asset('upload/images/technicaltools/' . $tech->technicalTool->image) }}" alt="Tool Image" width="60">
                                @else
                                N/A
                                @endif
                            </td>
