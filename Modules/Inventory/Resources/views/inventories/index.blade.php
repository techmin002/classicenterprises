                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <nav>
                                <div class="nav nav-tabs" id="inventory-tabs" role="tablist">
                                    <a class="nav-link active" id="accessories-tab" data-toggle="tab" href="#accessories" role="tab" aria-controls="accessories" aria-selected="true">
                                        Accessories
                                        <span class="badge badge-primary ml-2">{{ $filteredAccessories->count() }}</span>
                                    </a>
                                    <a class="nav-link" id="machineries-tab" data-toggle="tab" href="#machineries" role="tab" aria-controls="machineries" aria-selected="false">
                                        Machineries
                                        <span class="badge badge-primary ml-2">{{ $filteredMachineries->count() }}</span>
                                    </a>
                                    <a class="nav-link" id="technicaltools-tab" data-toggle="tab" href="#technicaltools" role="tab" aria-controls="technicaltools" aria-selected="false">
                                        Technical Tools
                                        <span class="badge badge-primary ml-2">{{ $filteredTechnicalTools->count() }}</span>
                                    </a>
                                </div>
                            </nav>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="tab-content" id="inventory-tabs-content">
                                        ...
                                        <table id="example1" class="table table-hover table-bordered table-striped text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('inventory.accessories', $inventory->accessories->id) }}" class="btn btn-sm btn-info" title="View">
                                ...
                                <!-- Machineries Tab -->
                                <div class="tab-pane fade" id="machineries" role="tabpanel" aria-labelledby="machineries-tab">
                                        ...
                                        <table id="example2" class="table table-hover table-bordered table-striped text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('inventory.machineries', $inventory->machineries->id) }}" class="btn btn-sm btn-info" title="View">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                    </td>
                                                    {{-- @canany(['edit_inventory', 'delete_inventory'])
                                ...
                                <!-- Technical Tools Tab -->
                                <div class="tab-pane fade" id="technicaltools" role="tabpanel" aria-labelledby="technicaltools-tab">
