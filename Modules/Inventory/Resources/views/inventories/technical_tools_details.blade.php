                        ...
                        <div class="card-body">
                            <div class="tab-content" id="inventory-tabs-content">
                                ...
                                <div class="tab-pane fade show active" id="accessories" role="tabpanel">
                                    @if($technicaltools->isEmpty())
                                    <div class="alert alert-info">
                                        <i class="fas fa-info-circle"></i>
                                        No Technical Tools inventory found
                                    </div>
                                    @else
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-bordered table-striped table-hover text-center">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($technicaltools as $inventory)
                                                <tr>
                                                    <td>{{ $sn++ }}</td>
                                                ...
                                                @foreach ($transferTechnicaltools as $item)
                                                <tr>
                                                    <td>{{ $sn++ }}</td>
                                                    <td>{{ $item->technicaltools->tool_name }}</td>
                                                    <td>{{ $item->quantity }}</td>
