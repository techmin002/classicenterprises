                ...
                <div class="container">
                    <div class="row gy-3">
                        ...
                        @if ($value->payment_type === 'payment')
                            <div class="mt-3 col-lg-6">
                                <label class="form-label12">Payment Mode:</label>
                                <input class="form-control" value="{{ ucfirst($value->mode) }}" readonly>
                            </div>
                        @endif
                        <div class="mt-3 col-lg-6">
                            <label class="form-label12">Service Center: </label>
                            <input class="form-control" value="{{ $value->service_center ?? 'N/A' }}" readonly>
                        </div>
                        <div class="mt-3 col-lg-6">
