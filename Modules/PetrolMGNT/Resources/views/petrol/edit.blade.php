    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="border-radius: 8px;">
            <div class="modal-header justify-content-center" style="background-color: #0837a4; color: #fff;">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">Edit Petrol For Bike</h1>
            </div>
                    ...
                    <div class="container">
                        <div class="row gy-3">
                            ...
                            <div class="col-lg-6 mt-3">
                                ...
                                @if ($value->image)
                                    <small class="text-muted">Current: <a href="{{ asset('upload/images/petrol-receipt/' . $value->image) }}" target="_blank">View Receipt</a></small>
                                @endif
                            </div>
