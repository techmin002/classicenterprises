            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title float-right"><a class="btn btn-primary text-white" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-plus"></i> Create</a> </h3>
                  @include('employee::leave-types.create')
                </div>
                <!-- /.card-header -->
                <div class="card-body">
