                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="requestcheckoutLabel">Chek-Out Request
                                                                </h5>
                                                                    ...
                                                                    <td>
                                                                        <div class="dropdown show">
                                                                            ...
                                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                                <a class="dropdown-item" href="{{ route('attendance.checkout.status', ['id' => $check->id, 'status' => 'accept']) }}">Accept</a>
                                                                                <a class="dropdown-item" href="{{ route('attendance.checkout.status', ['id' => $check->id, 'status' => 'reject']) }}">Reject</a>
