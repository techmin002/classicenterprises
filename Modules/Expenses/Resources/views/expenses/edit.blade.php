                    ...
                    <div class="container">
                        <div class="row gy-3">
                            ...
                            <div class="mt-3 col-lg-6">
                                ...
                                <input class="form-control" placeholder="Enter Title" value="{{ $exp->title }}" type="text" name="title" id="title" required>
                            </div>
                            <div class="mt-3 col-lg-6">
                                <label class="form-label12">Amount (NPR)</label>
                                <input class="form-control" placeholder="" type="text" value="{{ $exp->amount }}" name="amount" required>
                            </div>
                            <div class="mt-3 col-lg-6">
                                <label class="form-label12">Date</label>
                                <input class="form-control" placeholder="" type="date" value="{{ old('date', $exp->date) }}" name="date" id="date" required>
                            </div>
                             @if($type == "exp")
                            <div class="mt-3 col-lg-6">
                            ...
                            @else
                            <input type="hidden" name="mode" value="petty cash">
                            @endif
