                    ...
                    <div class="container">
                        <div class="row gy-3">
                            ...
                            <div class="mt-3 col-lg-6">
                                ...
                                <input class="form-control" placeholder="Enter Title" type="text" name="title" required
                                    id="title">
                            </div>
                            <div class="mt-3 col-lg-6">
                                <label class="form-label12">Amount (NPR)</label>
                                <input class="form-control" placeholder="" type="text" name="amount" required>
                            </div>
                            <div class="mt-3 col-lg-6">
                                <label class="form-label12">Date</label>
                                <input class="form-control" placeholder="" type="date" name="date" id="date" required>
                            </div>
                            @if ($type == 'exp')
                                <div class="mt-3 col-lg-6">
